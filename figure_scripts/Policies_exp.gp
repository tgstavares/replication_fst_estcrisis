...
set output "figure_scripts/Policyfns_2.eps"
...
set xlabel "intial profitability"
set title "Leverage"
plot dat3 index 0 u ($3):($10>0.0 ? $8 : 1/0) w lp pi -0.5 pt 71 lw 1 ps 0.3 lc 'black' title "baseline", \
     dat4 index 0 u ($3):($10>0.0 ? $8 : 1/0) w lp pi -0.5 pt 7  lw 1 ps 0.4 lc 'black' title "asset-based only"
