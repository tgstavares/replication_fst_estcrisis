program greek_crisis_exp
  ...
  if(iflag_turnashocks.eq.1)then
     ...
     iloc = minloc(abs( 0.06d0 - m%a)); iapath(108) = iloc(1)
     iloc = minloc(abs( 0.08d0 - m%a)); iapath(109) = iloc(1)
     iloc = minloc(abs(-0.03d0 - m%a)); iapath(110) = iloc(1)
     iloc = minloc(abs(-0.02d0 - m%a)); iapath(111) = iloc(1)
     iloc = minloc(abs(-0.07d0 - m%a)); iapath(112) = iloc(1)
     iloc = minloc(abs( 0.10d0 - m%a)); iapath(113) = iloc(1)
     iloc = minloc(abs( 0.16d0 - m%a)); iapath(114) = iloc(1)
  ...
  !open(3,file='plot_data/Distributions_cal_estimation_PUT_defcf_exporters.txt',position="rewind")
  !open(3,file='plot_data/Distributions_cal_estimation_PUTebkacc_drb_defcf_exporters.txt',position="rewind")
  !open(3,file='plot_data/Distributions_cal_estimation_PUTebkprov_drb_defcf_exporters.txt',position="rewind")
