program greek_crisis_exp
  ...
  open(1,file='functions/dwlk.txt',	position="rewind");read(1,*)m%dwlk	;close(1)
  ...
  !open(3,file='plot_data/Distributions_cal_estimation_PUT_defval.txt',position="rewind")
  !open(3,file='plot_data/Distributions_cal_estimation_PUT_dr_defval.txt',position="rewind")
  !open(3,file='plot_data/Distributions_cal_estimation_PUTebkacc_drb_defval.txt',position="rewind")
  !open(3,file='plot_data/Distributions_cal_estimation_PUTebkprov_drb_defval.txt',position="rewind")
  !open(3,file='plot_data/Distributions_cal_estimation_PUTebkacc_dwlk_defval.txt',position="rewind")
  !open(3,file='plot_data/Distributions_cal_estimation_PUTebkprov_dwlk_defval.txt',position="rewind")
