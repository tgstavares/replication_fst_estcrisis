program greek_crisis_exp
  ...
  !open(3,file='plot_data/Distributions_cal_estimation_PUT_defval_nonexporters.txt',position="rewind")
  !open(3,file='plot_data/Distributions_cal_estimation_PUTebkacc_drb_defval_nonexporters.txt',position="rewind")
  !open(3,file='plot_data/Distributions_cal_estimation_PUTebkprov_drb_defval_nonexporters.txt',position="rewind")
