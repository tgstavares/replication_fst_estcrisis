program greek_crisis_exp
  ...
  allocate(m%evg(nk,np,nz,na,nx,nd))
  allocate(m%ikp(nk*np*nz*na*nx*nd),m%ipp(nk*np*nz*na*nx*nd))
  allocate(m%vg(nk*np*nz*na*nx*nd),m%vc(nk*np*nz*na*nx*nd),m%pz(nz*nz*nx),m%pa(na*na),m%px(nx*nx))
  allocate(m%coefevg(4,4,nk,np,nz,na,nx,nd))
  ...
  open(1,file='functions/pdis.txt',     position="rewind");read(1,*)m%pdis	;close(1)
  ...
  if(iflag_creditshock.eq.0)then
     ...
     do tt0 = 110,114
        ...
        case (108)
           ...
           write(*,'(a40,3f12.4,i10)')'##### Getting simulation for sparam: ',m_2%sparam,m_2%tau,m_2%pdis,tt0
        ...
        case (109)
           ...
           write(*,'(a40,3f12.4,i10)')'##### Getting simulation for sparam: ',m_1%sparam,m_1%tau,m_1%pdis,tt0
           call get_equil(par,m_2,showoutput='y')
        ...
        case (110)
           ...
           write(*,'(a40,3f12.4,i10)')'##### Getting simulation for sparam: ',m0%sparam,m0%tau,m0%pdis,tt0
        ...
        case(111)
           ...
           write(*,'(a40,3f12.4,i10)')'##### Getting simulation for sparam: ',m1%sparam,m1%tau,m1%pdis,tt0
        ...
        case(112)
           ...
           write(*,'(a40,3f12.4,i10)')'##### Getting simulation for sparam: ',m2%sparam,m2%tau,m2%pdis,tt0
        ...
        case(113)
           ...
           write(*,'(a40,3f12.4,i10)')'##### Getting simulation for sparam: ',m3%sparam,m3%tau,m3%pdis,tt0
        ...
        case(114)
           ...
           write(*,'(a40,3f12.4,i10)')'##### Getting simulation for sparam: ',m4%sparam,m4%tau,m4%pdis,tt0
