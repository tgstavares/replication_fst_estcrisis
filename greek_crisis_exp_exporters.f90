program greek_crisis_exp
  ...
  if(iflag_creditshock.eq.0)then
     ...
     ! m_1%sparam = sparam*(1d0 - 0.001d0*(1d0+ee))
     ! m0%sparam = sparam*(1d0 - 0.003d0*(1d0+ee))
     ! m1%sparam = sparam*(1d0 - 0.020d0*(1d0+ee))
     ! m2%sparam = sparam*(1d0 - 0.025d0*(1d0+ee))
     ! m3%sparam = sparam*(1d0 - 0.048d0*(1d0+ee))
     ! m4%sparam = sparam*(1d0 - 0.065d0*(1d0+ee))     

     ! SPARAM UNDER PROVISION
     m_2%sparam = sparam*(1d0 - 0.001d0*(1d0+ee))
     m_1%sparam = sparam*(1d0 - 0.003d0*(1d0+ee))
     m0%sparam  = sparam*(1d0 - 0.014d0*(1d0+ee))
     m1%sparam  = sparam*(1d0 - 0.050d0*(1d0+ee))    
     m2%sparam  = sparam*(1d0 - 0.088d0*(1d0+ee))
     m3%sparam  = sparam*(1d0 - 0.15d0*(1d0+ee))
     m4%sparam  = sparam*(1d0 - 0.19d0*(1d0+ee))
  ...
  !open(3,file='plot_data/Distributions_cal_estimation_PU_exporters.txt',position="rewind")
  !open(3,file='plot_data/Distributions_cal_estimation_PUT_exporters.txt',position="rewind")
  !open(3,file='plot_data/Distributions_cal_estimation_PUTebkacc_exporters.txt',position="rewind")
  open(3,file='plot_data/Distributions_cal_estimation_PUTebkprov_exporters.txt',position="rewind")
