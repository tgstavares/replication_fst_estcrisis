program greek_crisis_exp
  ...
  real(dp) delta_alt(114) ! PUT ALTERNATIVE DELTAS IN HERE
  ...
  delta_alt(103) = 0.104459
  delta_alt(104) = 0.103278
  delta_alt(105) = 0.099610
  delta_alt(106) = 0.103460
  delta_alt(107) = 0.104650
  delta_alt(108) = 0.104243
  delta_alt(109) = 0.098225
  delta_alt(110) = 0.095918
  delta_alt(111) = 0.095498
  delta_alt(112) = 0.093405
  delta_alt(113) = 0.093650
  delta_alt(114) = 0.095459
  !delta_alt = par%delta
  ...
  if(iflag_creditshock.eq.0)then
     ...
     do tt0 = 110,114
        ...
        !initconds(:,1) = data(:,tt0-1,3)*(1d0-par%delta+0.0d0) + data(:,tt0-1,10)
     ...
     do tt0 = 103,107
        ...
        !initconds(:,1) = data(:,tt0-1,6) ! k0
        !initconds(:,1) = data(:,tt0-1,6) 	! k0
        initconds(:,1) = data(:,tt0-1,3)*(1d0-delta_alt(tt0)) + data(:,tt0-1,10)
  ...
  open(3,file='plot_data/Distributions_cal_estimation_PUT_utilization.txt',position="rewind")
