program main
  ...
  par%a       = 0.57500d0
  par%ps      = 0.00950d0
  par%sparam1 = 0.57400d0
  par%sparam2 = 1.43000d0
  ...
  open(1,file='functions/r.txt',	position="rewind");write(1,*)m%r	;close(1)
  open(1,file='functions/beta.txt',	position="rewind");write(1,*)m%beta	;close(1)
  open(1,file='functions/dwlk.txt',	position="rewind");write(1,*)m%dwlk	;close(1)
