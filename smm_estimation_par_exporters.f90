program smm_estimation_par
  ...
  smm%min_dl = 0.10770d0;	smm%max_dl = 0.10970d0 !smm%min_dl
  smm%min_aa = 0.56500d0;	smm%max_aa = 0.58500d0 !smm%min_aa
  smm%min_ps = 0.00900d0;	smm%max_ps = 0.01000d0 !smm%min_ps
  smm%min_s1 = 0.57200d0;	smm%max_s1 = 0.57600d0 !smm%min_s1
  smm%min_s2 = 1.43000d0;	smm%max_s2 = 1.44000d0 !smm%min_s2
