program smm_estimation_par
  ...
  smm%min_dl = 0.09800d0;	smm%max_dl = 0.10000d0!smm%min_dl
  smm%min_aa = 0.66667d0;	smm%max_aa = 0.68667d0!smm%min_aa
  smm%min_ps = 0.03950d0;	smm%max_ps = 0.04150d0!smm%min_ps
  smm%min_s1 = 0.60400d0;	smm%max_s1 = 0.61200d0!smm%min_s1
  smm%min_s2 = 1.09800d0;	smm%max_s2 = 1.11800d0!smm%min_s2
