program stats
  ...
  if(iflag_saveshocks.eq.1)then
     open(1,file='functions/shocksz_nonexporters.dat',position="rewind");write(1,*)shocksz;close(1)
     open(1,file='functions/shocksa_nonexporters.dat',position="rewind");write(1,*)shocksa;close(1)
     open(1,file='functions/shocksx_nonexporters.dat',position="rewind");write(1,*)shocksx;close(1)
     open(1,file='functions/iapath_nonexporters.dat',position="rewind");write(1,*)iapath;close(1)
     open(1,file='functions/ixpath_nonexporters.dat',position="rewind");write(1,*)ixpath;close(1)
  end if
