...
module toolbox
  ...
  end interface log_normal_discrete
  ...
  end interface simulate_uniform
  ...
  end interface simulate_log_normal
  ...
  end interface simulate_bernoulli
  ...
  end interface simulate_binomial
